...
function Install_Spotify {
    try {
        ...
        $outputPath = "C:\Users\Administrator\AppData\Local\SpotifySetup.exe"
        Start-BitsTransfer -Source $url -Destination $outputPath
        Start-Process -FilePath $outputPath -ArgumentList "/silent"
        Start-Sleep -Seconds 10
        Start-Process -FilePath "C:\Users\Administrator\AppData\Roaming\Spotify\spotify.exe"
...
function Install_Discord {
    try {
        ...
        $outputPath = "C:\Users\Administrator\AppData\Local\DiscordSetup.exe"
        Start-BitsTransfer -Source $url -Destination $outputPath
        Start-Process -FilePath $outputPath -ArgumentList "/silent"
        Start-Sleep -Seconds 10
        Start-Process -FilePath "C:\Users\Administrator\AppData\Local\Discord\app-1.0.9048\Discord.exe"
...
$Tab3.Header = "V2rvivahetaja & Skripti Sisend"
